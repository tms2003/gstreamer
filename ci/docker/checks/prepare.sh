...
apt-get install --assume-yes devscripts build-essential dpkg-dev wget pkg-config libssl-dev
...
# Clean up
apt-get remove --assume-yes devscripts build-essential dpkg-dev wget pkg-config libssl-dev
