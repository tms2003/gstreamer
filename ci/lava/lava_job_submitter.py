...
class LAVAJobSubmitter(PathResolver):
    ...
    gstreamer_job_name: str = "gstreamer_ci_job"
    pipeline_info: str = ""
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        # Remove gstreamer job names with spaces, which breaks the lava-test-case command
        self.gstreamer_job_name = self.gstreamer_job_name.split(" ")[0]
