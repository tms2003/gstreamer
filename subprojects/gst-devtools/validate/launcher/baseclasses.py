...
class GstValidateTest(Test):
    ...
    def get_subproc_env(self):
        ...
        vaildateconfigs_path = os.environ.get('GST_VALIDATE_TEST_INCLUDE_PATH', "")
        ...
        subproc_env['GST_VALIDATE_TEST_INCLUDE_PATH'] = vaildateconfigs_path
        self.add_env_variable('GST_VALIDATE_TEST_INCLUDE_PATH', vaildateconfigs_path)
