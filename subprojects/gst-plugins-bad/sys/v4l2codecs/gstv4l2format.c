...
static struct FormatEntry format_map[] = {
  ...
  {V4L2_PIX_FMT_NV15, 1, GST_VIDEO_FORMAT_NV12_10LE40, 10, 420},
  {V4L2_PIX_FMT_NV16, 1, GST_VIDEO_FORMAT_NV16, 8, 420},
  {V4L2_PIX_FMT_NV20, 1, GST_VIDEO_FORMAT_NV16_10LE40, 10, 420},
  {0,}
};
