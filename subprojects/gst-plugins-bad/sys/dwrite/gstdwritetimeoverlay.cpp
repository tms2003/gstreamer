...
static void gst_dwrite_time_overlay_set_context (GstElement * elem,
    GstContext * context);
static gboolean gst_dwrite_time_overlay_start (GstBaseTransform * trans);
static gboolean gst_dwrite_time_overlay_stop (GstBaseTransform * trans);
static gboolean gst_dwrite_time_overlay_query (GstBaseTransform * trans,
    GstPadDirection direction, GstQuery * query);
static gboolean
gst_dwrite_time_overlay_decide_allocation (GstBaseTransform * trans,
    GstQuery * query);
static gboolean
gst_dwrite_time_overlay_propose_allocation (GstBaseTransform * trans,
    GstQuery * decide_query, GstQuery * query);
static void gst_dwrite_time_overlay_before_transform (GstBaseTransform * trans,
    GstBuffer * buf);
static gboolean
gst_dwrite_time_overlay_set_info (GstBaseTextLayoutOverlay * overlay,
    GstCaps * in_caps, const GstVideoInfo * in_info,
    GstCaps * out_caps, const GstVideoInfo * out_info);
static GstFlowReturn
gst_dwrite_time_overlay_generate_layout (GstBaseTextLayoutOverlay * overlay,
    const gchar * text, GstBuffer * buffer, GstTextLayout ** layout);
static GstFlowReturn
gst_dwrite_time_overlay_generate_output (GstBaseTextLayoutOverlay * overlay,
...
gst_dwrite_time_overlay_class_init (GstDWriteTimeOverlayClass * klass)
{
  ...
  element_class->set_context =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_set_context);

  trans_class->start = GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_start);
  trans_class->stop = GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_stop);
  trans_class->query = GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_query);
  trans_class->decide_allocation =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_decide_allocation);
  trans_class->propose_allocation =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_propose_allocation);
  trans_class->before_transform =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_before_transform);

  overlay_class->set_info =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_set_info);
  overlay_class->generate_layout =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_generate_layout);
  overlay_class->generate_output =
      GST_DEBUG_FUNCPTR (gst_dwrite_time_overlay_generate_output);
...
static void
gst_dwrite_time_overlay_set_context (GstElement * elem, GstContext * context)
{
  GstDWriteTimeOverlay *self = GST_DWRITE_TIME_OVERLAY (elem);
  GstDWriteTimeOverlayPrivate *priv = self->priv;
...
static gboolean
gst_dwrite_time_overlay_stop (GstBaseTransform * trans)
{
  GstDWriteTimeOverlay *self = GST_DWRITE_TIME_OVERLAY (trans);
  GstDWriteTimeOverlayPrivate *priv = self->priv;
...
static gboolean
gst_dwrite_time_overlay_query (GstBaseTransform * trans,
    GstPadDirection direction, GstQuery * query)
{
  GstDWriteTimeOverlay *self = GST_DWRITE_TIME_OVERLAY (trans);
  GstDWriteTimeOverlayPrivate *priv = self->priv;
...
static void
gst_dwrite_time_overlay_before_transform (GstBaseTransform * trans,
    GstBuffer * buf)
{
  GstDWriteTimeOverlay *self = GST_DWRITE_TIME_OVERLAY (trans);
  GstDWriteTimeOverlayPrivate *priv = self->priv;
