...
#define MXF_INDEX_ENTRY_FLAGS_IS_SET(flags,flag)                !!(flags & (flag))
#define MXF_INDEX_ENTRY_FLAGS_IS_SET_OFFSET_OUT_OF_RANGE(flags) MXF_INDEX_ENTRY_FLAGS_IS_SET (flags, MXF_INDEX_ENTRY_FLAG_OFFSET_OUT_OF_RANGE)
#define MXF_INDEX_ENTRY_FLAGS_IS_SET_BACKWARD_PREDICTION(flags) MXF_INDEX_ENTRY_FLAGS_IS_SET (flags, MXF_INDEX_ENTRY_FLAG_BACKWARD_PREDICTION)
#define MXF_INDEX_ENTRY_FLAGS_IS_SET_FORWARD_PREDICTION(flags)  MXF_INDEX_ENTRY_FLAGS_IS_SET (flags, MXF_INDEX_ENTRY_FLAG_FORWARD_PREDICTION)
#define MXF_INDEX_ENTRY_FLAGS_IS_SET_SEQUENCE_HEADER(flags)     MXF_INDEX_ENTRY_FLAGS_IS_SET (flags, MXF_INDEX_ENTRY_FLAG_SEQUENCE_HEADER)
#define MXF_INDEX_ENTRY_FLAGS_IS_SET_RANDOM_ACCESS(flags)       MXF_INDEX_ENTRY_FLAGS_IS_SET (flags, MXF_INDEX_ENTRY_FLAG_RANDOM_ACCESS)
#define MXF_INDEX_ENTRY_FLAGS_IS_SET_DELTA_UNIT(flags)          MXF_INDEX_ENTRY_FLAGS_IS_SET (flags, MXF_INDEX_ENTRY_FLAG_BACKWARD_PREDICTION | MXF_INDEX_ENTRY_FLAG_FORWARD_PREDICTION)

#define MXF_INDEX_ENTRY_FLAGS_SET(flags,flag)                (flags |= (flag))
#define MXF_INDEX_ENTRY_FLAGS_UNSET(flags,flag)              (flags &= ~(flag))

#define MXF_INDEX_ENTRY_FLAGS_SET_OFFSET_OUT_OF_RANGE(flags) MXF_INDEX_ENTRY_FLAGS_SET (flags, MXF_INDEX_ENTRY_FLAG_OFFSET_OUT_OF_RANGE)
#define MXF_INDEX_ENTRY_FLAGS_SET_BACKWARD_PREDICTION(flags) MXF_INDEX_ENTRY_FLAGS_SET (flags, MXF_INDEX_ENTRY_FLAG_BACKWARD_PREDICTION)
#define MXF_INDEX_ENTRY_FLAGS_SET_FORWARD_PREDICTION(flags)  MXF_INDEX_ENTRY_FLAGS_SET (flags, MXF_INDEX_ENTRY_FLAG_FORWARD_PREDICTION)
#define MXF_INDEX_ENTRY_FLAGS_SET_SEQUENCE_HEADER(flags)     MXF_INDEX_ENTRY_FLAGS_SET (flags, MXF_INDEX_ENTRY_FLAG_SEQUENCE_HEADER)
#define MXF_INDEX_ENTRY_FLAGS_SET_RANDOM_ACCESS(flags)       MXF_INDEX_ENTRY_FLAGS_SET (flags, MXF_INDEX_ENTRY_FLAG_RANDOM_ACCESS)

#define MXF_INDEX_ENTRY_FLAGS_UNSET_RANDOM_ACCESS(flags)     MXF_INDEX_ENTRY_FLAGS_UNSET (flags, MXF_INDEX_ENTRY_FLAG_RANDOM_ACCESS)

typedef enum
{
  MXF_INDEX_ENTRY_FLAGS_NONE               = 0,
  MXF_INDEX_ENTRY_FLAG_OFFSET_OUT_OF_RANGE = (1 << 3),
  MXF_INDEX_ENTRY_FLAG_BACKWARD_PREDICTION = (1 << 4),
  MXF_INDEX_ENTRY_FLAG_FORWARD_PREDICTION  = (1 << 5),
  MXF_INDEX_ENTRY_FLAG_SEQUENCE_HEADER     = (1 << 6),
  MXF_INDEX_ENTRY_FLAG_RANDOM_ACCESS       = (1 << 7),
  /* By default every entry is a random_access_point & keyframe
   * unless specified otherwise */
  MXF_INDEX_ENTRY_FLAGS_DEFAULT            = MXF_INDEX_ENTRY_FLAG_RANDOM_ACCESS,
} MXFIndexEntryFlags;
