...
gstmask_to_wavmask (guint64 gstmask, GstAudioChannelPosition * pos)
{
  const GstAudioChannelPosition valid_pos =
      ...
      GST_AUDIO_CHANNEL_POSITION_MASK (FRONT_LEFT_OF_CENTER) |
      GST_AUDIO_CHANNEL_POSITION_MASK (FRONT_RIGHT_OF_CENTER) |
