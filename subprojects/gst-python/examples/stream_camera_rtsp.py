...
def run_rtsp_server(rtsp_port, device, stream_name):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rtsp_port", default="8557")
    parser.add_argument("--stream_name", default="cam")
    args = parser.parse_args()
    Gst.init(None)
    run_rtsp_server(args.rtsp_port, args.camera, args.stream_name)
    loop = GLib.MainLoop()
    loop.run()
