 ...
 * @GST_VIDEO_ANCILLARY_DID16_RP214_KLV_VANC: KLV VANC data according to SMPTE RP214 (Since: 1.20)
 * @GST_VIDEO_ANCILLARY_DID16_RP214_KLV_HANC: KLV HANC data according to SMPTE RP214 (Since: 1.20)
 *
...
typedef enum {
  ...
  GST_VIDEO_ANCILLARY_DID16_RP214_KLV_VANC      = 0x4404,
  GST_VIDEO_ANCILLARY_DID16_RP214_KLV_HANC      = 0x4414
} GstVideoAncillaryDID16;
