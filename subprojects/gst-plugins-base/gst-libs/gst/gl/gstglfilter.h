...
struct _GstGLFilterClass
{
  ...
  gboolean (*filter)            (GstGLFilter *filter, const GstBuffer *inbuf, GstBuffer *outbuf);
...
GST_GL_API
gboolean gst_gl_filter_filter_texture (GstGLFilter * filter, const GstBuffer * input,
                                       GstBuffer * output);
